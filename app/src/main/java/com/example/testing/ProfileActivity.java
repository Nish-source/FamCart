...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        findViewById(R.id.layout_gold_membership).setOnClickListener(v ->
    ...
    private void loadUserData() {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                tvUserName.setText(name != null && !name.isEmpty() ? name : "FamCart User");
    ...
    private void loadStats() {
        ...
        userRef.child("orders").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                tvOrdersCount.setText(String.valueOf(snapshot.getChildrenCount()));
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {}
        });
        ...
        userRef.child("rewards").child("coins").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                tvPoints.setText(String.valueOf(coins));
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {}
        });
